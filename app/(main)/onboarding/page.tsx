...
export default function OnboardingPage() {
  return (
    <main className="safe-bottom flex min-h-dvh flex-1 flex-col items-center justify-center gap-8 bg-[#FAF6EF] px-6 py-16 pb-6 text-center font-serif text-[#3d3833]">
